...
export function LoginScreen() {
  ...
  return (
    <>
      <AnimatePresence>
        {isLoading && <LoginLoading onComplete={handleLoadingComplete} />}
      </AnimatePresence>
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center p-12 text-white w-full">
            ...
            >
              <h1 className="text-5xl font-bold mb-4">PACK-D</h1>
              <p className="text-xl text-white/90">Workpack Management System</p>
              <p className="text-white/70 mt-2">Streamline your project workflows</p>
            </motion.div>
            ...
            >
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Create, submit, and track workpacks seamlessly</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">Work together with reviewers and contractors</p>
                </div>
              </div>
